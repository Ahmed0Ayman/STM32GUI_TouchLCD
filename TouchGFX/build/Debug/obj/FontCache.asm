; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30038.1 
	...
	TITLE	C:\TouchGFXProjects\MyApplication_9\TouchGFX\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__22D35644_FontCache@hpp DB 01H
__2FA4ED8F_ConstFont@hpp DB 01H
__47DB96C0_GeneratedFont@hpp DB 01H
__AD5BA438_CachedFont@hpp DB 01H
__75FE6DB6_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1MK@DLJPHCC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1MK@DLJPHCC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1MK@DLJPHCC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	...
	DB	'x', 00H, '\', 00H, 'T', 00H, 'y', 00H, 'p', 00H, 'e', 00H, 'd'
	DB	00H, 'T', 00H, 'e', 00H, 'x', 00H, 't', 00H, '.', 00H, 'h', 00H
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_9\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 79
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __AD5BA438_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_9\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 419
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __75FE6DB6_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 420
	mov	eax, DWORD PTR _this$[ebp]
...
$LN3@assertVali:
	mov	esi, esp
	push	174					; 000000aeH
	push	OFFSET ??_C@_1MK@DLJPHCC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_9\Middlewares\ST\touchgfx\framework\include\touchgfx\Font.hpp
; Line 419
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __0975A6EC_Font@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 420
	xor	eax, eax
; Line 421
